...
function getAbout() {
    ...
    Swal.fire({
        ...
        <br/>
        <div id="about">
            <b>College Project for 7th Semester</b> 
        </div>
        </br>
        <div id="author">Developers:<a href="https://www.linkedin.com/in/dipesh-jaiswal" target="_blank"> Dipesh Jaiswal</a>
        <a href="https://www.linkedin.com/in/harshdata" target="_blank"> Harsh Patel</a>
